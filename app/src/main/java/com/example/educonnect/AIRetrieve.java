...
public class AIRetrieve extends AppCompatActivity {
    ...
    private void displayPdfs() {
        ...
        pRef = FirebaseDatabase.getInstance().getReference().child("AIpdfs");
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull  DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    progressBar.setVisibility(View.GONE);
                    Toast.makeText(AIRetrieve.this, ":", Toast.LENGTH_SHORT).show();
                }
            }

...
public class AndroidRetrieve extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_android_retrieve);
    ...
    private void displayPdfs() {
        ...
        pRef = FirebaseDatabase.getInstance().getReference().child("Androidpdfs");
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull  DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    progressBar.setVisibility(View.GONE);
                    Toast.makeText(AndroidRetrieve.this, ":", Toast.LENGTH_SHORT).show();
                }
            }

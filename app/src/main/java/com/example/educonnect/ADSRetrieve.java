...
public class ADSRetrieve extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adsretrieve);
    ...
    private void displayPdfs() {
        ...
        pRef = FirebaseDatabase.getInstance().getReference().child("ADSpdfs");
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull  DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    progressBar.setVisibility(View.GONE);
                    Toast.makeText(ADSRetrieve.this, ":", Toast.LENGTH_SHORT).show();
                }
            }

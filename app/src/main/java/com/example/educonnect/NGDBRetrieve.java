...
public class NGDBRetrieve extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ngdbretrieve);
    ...
    private void displayPdfs() {
        ...
        pRef = FirebaseDatabase.getInstance().getReference().child("NGDBpdfs");
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull  DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    progressBar.setVisibility(View.GONE);
                    Toast.makeText(NGDBRetrieve.this, ":", Toast.LENGTH_SHORT).show();
                }
            }

...
public class NotesTeacher extends AppCompatActivity {
    ...
    private void UploadFile() {
        if (filepath != null) {
            ...
            progressDialog.show();
            StorageReference sref = storageReference.child("Notes " + formattedDate + ".pdf");
            ...
            sref.putFile(filepath)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(NotesTeacher.this, "Uploaded Succesfully", Toast.LENGTH_SHORT).show();
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(NotesTeacher.this, "Failed", Toast.LENGTH_SHORT).show();
                        }
                    })
